...
const Hero = () => {
	return (
		<div className='p-10 sm:p-6 bg-gradient-to-r from-black to-primary-gold '>
			<div className='flex flex-col lg:flex-row justify-center px-4 sm:px-8 items-center max-w-7xl mx-auto gap-6 lg:gap-0'>
				<div className='text-white w-full flex flex-col gap-5 order-2 lg:order-1'>
